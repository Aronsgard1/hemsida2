        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-foreground/70 leading-relaxed mb-8">
                Min vision är att kunna leverera nyckelfärdiga hus, gärna byggda med återvunna och hållbara material. Jag vill ta rollen som totalentreprenör och leda hela projektet – från idé till färdigt hem. I dessa projekt önskar jag också skapa den fasta inredningen själv: handbyggda kök, garderober, kommoder och andra specialsnickerier som ger varje hem en unik karaktär och en tydlig hantverkskänsla.
              </p>
              <p className="text-foreground/70 leading-relaxed mb-8">
