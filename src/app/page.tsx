    ...
    <>
      ...
      >
        ...
        <div className="absolute bottom-6 right-6 z-10 pointer-events-none">
          <p className="text-white/60 text-xs font-light">Vy mot Frösön/Östersund från Trägsta</p>
        </div>
      ...
      {/* Lösvirkeshus */}
      <section className="section-padding" style={{ backgroundColor: "#3d3d3d" }}>
        <div className="container mx-auto">
      ...
      <section className="section-padding" style={{ backgroundColor: "#e8dfd4" }}>
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button size="xl" asChild className="bg-slate-700/40 border border-slate-600/50 text-gray-800 hover:bg-slate-700/20 transition-colors">
              <a href="tel:+46738000979" className="flex items-center gap-2">
