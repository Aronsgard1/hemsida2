...
const Projekt = () => (
  <Layout>
    <SEOHead
      ...
      description="Se alla våra byggprojekt i Jämtland – lösvirkeshus, timmerhus, takbyten, fasadrenoveringar, om- och tillbyggnader samt jordbruksbyggnader."
      canonical="/projekt"
    />
    ...
    <section className="section-padding">
      <div className="container mx-auto">
        ...
        <p className="mt-4 text-muted-foreground max-w-2xl text-lg leading-relaxed">
          Aronsgård Bygg & Service erbjuder ett komplett utbud av byggtjänster i Hallen, Frösön och hela Jämtland. Vi utför allt från nybyggnation av lösvirkeshus och timmerhus till renoveringar och specialiserade jordbruksbyggnader. Varje projekt genomförs med fokus på kvalitet, planering och hållbara lösningar.
        </p>
